                                ...
                                <div class="m-t-40">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span
                                                class="text-gray font-weight-semibold font-size-13">Monthly
                                                Goal</span>
                                        </div>
                                        <span class="text-dark font-weight-semibold font-size-13">70%
                                        </span>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="m-t-40">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="text-dark font-weight-semibold font-size-13">60%
                                        </span>
                                    </div>
                                    <div class="progress progress-sm w-100 m-b-0 m-t-10">
                            ...
                            <div class="card-body">
                                ...
                                <div class="m-t-40">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="text-dark font-weight-semibold font-size-13">45%
                                        </span>
                                    </div>
                                    <div class="progress progress-sm w-100 m-b-0 m-t-10">
                            ...
                            <div class="card-body">
                                ...
                                <div class="m-t-40">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="text-dark font-weight-semibold font-size-13">50%
                                        </span>
                                    </div>
                                    <div class="progress progress-sm w-100 m-b-0 m-t-10">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <span class="text-muted font-size-13">Home
                                                    Decoration</span>
                                            </div>
                                        </div>
                                        <span class="badge badge-pill badge-cyan font-size-12">
                                ...
                                <li class="list-group-item p-h-0">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                <h6 class="m-b-0">
                                                    <a href="javascript:void(0);" class="text-dark">Beat
                                                        Headphone</a>
                                                </h6>
                                ...
                                <li class="list-group-item p-h-0">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                <h6 class="m-b-0">
                                                    <a href="javascript:void(0);" class="text-dark">Wooden
                                                        Rhino</a>
                                                </h6>
                                                <span class="text-muted font-size-13">Home
                                                    Decoration</span>
                                ...
                                <li class="list-group-item p-h-0">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                <h6 class="m-b-0">
                                                    <a href="javascript:void(0);" class="text-dark">Red
                                                        Chair</a>
                                                </h6>
                                                <span class="text-muted font-size-13">Home
                                                    Decoration</span>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span
                                                        class="badge badge-danger badge-dot m-r-10"></span>
                                                    <span>Rejected</span>
                                                </div>
                                            </td>
                                        </tr>
